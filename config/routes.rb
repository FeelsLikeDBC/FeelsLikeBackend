...
# Actual Temp
  ...
  match '/city/:id/actual_monthly_crushed' => "weather_day#actual_monthly_crushed", :via => [:get]
...
# Rise Set
  ...
  match '/city/:id/rise_set_monthly_crushed' => "weather_day#rise_set_monthly_crushed", :via => [:get]
...
# Everything Else
  ...
  match '/city/:id/everything_else_monthly_crushed' => "weather_day#everything_else_monthly_crushed", :via => [:get]
